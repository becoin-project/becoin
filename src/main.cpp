...
uint256 hashGenesisBlock("0xabf83ff79ccf0f8d76300ba363038a66aeb4b458eefca63e625dabc8384a2f8c");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // BeCoin: 1 days
static const int64 nTargetSpacing = 300; // BeCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal becoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Benedict Cumberbatch takes to the streets of Manhattan as Marvel Comics' Dr Strange";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1459618391; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 449054;

        if (fTestNet)
        {
            block.nTime    = 1459618391;
            block.nNonce   = 449054;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1462549a7304c9c1e78674e0b1769dfeb358618630eea3fe45609f68980dedfe"));
